...
@Command({
  name: 'init-go-api-boilerplate',
  aliases: ['i-go-api'],
  description: 'Initialize Typescript with Go Api boilerplate',
})
export class InitGoApiBoilerplateCommand extends CommandRunner {
  constructor(
  ...
  public async run(
    ...
    const repositoryEntity = RepositoryEntity.make(
      'vai-ts-go-api-boilerplate',
      `https://github.com/heronlabs/vai-ts-go-api-boilerplate/archive/refs/tags/${version}.zip`,
      version
    );
    ...
    this.consolePresenter.envelope(
      'GoApi Boilerplate initialized successfully! 📦 🃏 📘'
    );
  }
}
